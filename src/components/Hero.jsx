      ...
      <Container>
        <div className="lg:grid lg:grid-cols-12 lg:gap-x-8 lg:gap-y-20">
          ...
          <div className="relative z-10 mx-auto max-w-2xl lg:col-span-7 lg:max-w-none lg:pt-6 xl:col-span-6">
            <Title title="Voice To Text " className="text-5xl" />
            <p className="mt-6 text-lg text-gray-600">
            When it comes to choosing a transcribing app, quality and accuracy is critical. Whether you’re writing important articles or taking notes for class, you need to be able to trust that the app you’re using will produce a good output.
            </p>
            <div className="mt-8 flex flex-wrap items-center gap-x-6 gap-4">
              
              <Button variant="outline" href="#">
                
                <span className="ml-2.0">Free Trial</span>
              </Button>             
              <Button variant="outline" href="#">
                
                <span className="ml-2.0">Get Subscription</span>
              </Button>
            </div>
          </div>
          {/* Left side */}
